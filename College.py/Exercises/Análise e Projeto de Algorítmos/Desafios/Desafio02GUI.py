        ...
        for i in range(h):
            ...
            while cond < w:
                ...
                if x != 0 and x != 1:
                    ...
                    cond += 1
    for i in range(h):
        elem = tk.Label(upper_frame, textvariable=matriz, fg='red')
        elem.pack()
...
inserir_1 = tk.Button(frame, text="1 – Inserir a imagem (criar a matriz (max. 20x20)", bg='black', fg='white', padx=30, command=lambda: inserir(height,width.get()))
inserir_1.pack()
